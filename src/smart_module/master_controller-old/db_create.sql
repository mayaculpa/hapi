...
CREATE TABLE site (site_id int, name text, wunder_key text, operator text, email text, phone text, location text, longitude text, latitude text, net_iface text, serial_port text, twilio_acct_sid text, twilio_auth_token text);
...
CREATE TABLE assets(asset_id INT, rtuid TEXT, abbreviation TEXT, name TEXT, pin TEXT, unit TEXT, context TEXT, system TEXT, enabled INT);
